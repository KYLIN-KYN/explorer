...
if (settings.heavy != true) {
  bitcoinapi.setAccess('only', ['getinfo', 'getnetworkhashps', 'getmininginfo','getdifficulty', 'getconnectioncount', 
    'getblockcount', 'getblockhash', 'getblock', 'getrawtransaction', 'masternodelist']);
} else {
  ...
  */
  bitcoinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount', 
    ...
    'getnextrewardwhensec', 'getsupply', 'masternodelist']);
}
// view engine setup
...
app.use('/ext/nodenum', function(req,res){
	lib.get_masternodelist(function(num){
		res.send({data: num.length});
	});
});
